    ...
    <script type="text/javascript">
        ...
        $(document).on('click', '.feed-element', function(e){
            ...
            $.ajax({
                headers : header,
                type : 'GET',
                url : '/detailpertanyaan-pj/' + idChat,
                success:function(data){
        ...
        $(document).on('click', '.bKirim', function(e){
            ...
            var idPenerima = document.getElementById('idPengirim').innerHTML;
        ...
        $(document).on('click', '.review-tempat', function(e){
            var url = window.location.origin + '/detail-tempat/' + this.id;
